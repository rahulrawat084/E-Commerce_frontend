...
export default function AdminVendorSales(){
    ...
    const IMAGE_BASE_URL=`${process.env.REACT_APP_BACKEND_URL}/productimages/`;
    ...
    const fetchSalesManually=async()=>{
        ...
        try{
            const res=await axios.get(`${process.env.REACT_APP_BACKEND_URL}/sales/vender/${selectedVender}`);
