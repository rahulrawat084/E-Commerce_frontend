   ...
   import "./City.css";
     ...
     function CityMgt()
     {
        ...
        useEffect(()=>{
              axios.get(`${process.env.REACT_APP_BACKEND_URL}/state/show`).then((res)=>{
                setStList(res.data);
              }).catch((err)=>{
                alert(err);
              });
              ...
              const handleAddNewButton=()=>{
                axios.get(`${process.env.REACT_APP_BACKEND_URL}/city/getall`).then((res)=>{
            ...
            const handleSaveButton=()=>{
                if(ctid=="" || ctid==undefined || ctname=="" || ctname==undefined || stid=="" || stid==undefined || status=="" || status==undefined || stid=="0")
                {
                 ...
                 return;   
                    ...
                    axios.get(`${process.env.REACT_APP_BACKEND_URL}/city/searchbyname/${ctname}`).then((res)=>{
                        ...
                        else
                        {
                            ...
                            axios.post(`${process.env.REACT_APP_BACKEND_URL}/city/save/`,obj).then((res)=>{
                                alert(res.data);
                                setCtId("");
                                setCtName("");
                                setStId("");
                ...
                const handleSearchButton=()=>{
                    ...
                    {
                        axios.get(`${process.env.REACT_APP_BACKEND_URL}/city/search/${ctid}`).then((res)=>{
                ...
                const handleUpdateButton=()=>{
                    ...
                    else
                    {
                        ...
                        axios.put(`${process.env.REACT_APP_BACKEND_URL}/city/update/`,obj).then((res)=>{
                            alert(res.data);
                            setCtId("");
                            setCtName("");
                            setStId("");
                      ...
                      const handleDeleteButton=()=>{
                        if(ctid!=undefined && ctid!="")
                        {
                            axios.delete(`${process.env.REACT_APP_BACKEND_URL}/city/delete/${ctid}`).then((res)=>{
                                alert(res.data);
                            }).catch((err)=>{
                                alert(err);
                            })
