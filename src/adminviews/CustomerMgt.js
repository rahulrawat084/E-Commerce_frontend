...
function CustomerMgt(){
    ...
    useEffect(()=>{
        axios.get(`${process.env.REACT_APP_BACKEND_URL}/customer/getcustomercount`)
        .then((res)=>setCustomerList(res.data))
        .catch((err)=> console.error(err));

        axios.get(`${process.env.REACT_APP_BACKEND_URL}/state/show`)
    ...
    const handleViewProfile=(cid)=>{
        ...
        .then((res)=>{
            ...
            setPreviewImage(
                res.data.CPicName 
                ? `${process.env.REACT_APP_BACKEND_URL}/customer/getimage/${res.data.CPicName}`
                : null
            );
    ...
    const fetchCitiesByState=(stid)=>{
        axios.get(`${process.env.REACT_APP_BACKEND_URL}/city/showcitybystate/${stid}`)
