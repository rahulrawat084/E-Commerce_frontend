...
function ProductList(props) {
    ...
    useEffect(() => {
        ...
        axios
            .get(`${process.env.REACT_APP_BACKEND_URL}/product/showproduct`)
            .then((res) => setPList(res.data))
            .catch((err) => alert(err));

        axios
            .get(`${process.env.REACT_APP_BACKEND_URL}/productcatg/showproductcatg`)
    ...
    const handleBuyButton = (pid) => {
        ...
        axios
            .get(`${process.env.REACT_APP_BACKEND_URL}/product/showproduct/${pid}`)
            .then((res) => {
    ...
    const url =
        catgId > 0
            ? `${process.env.REACT_APP_BACKEND_URL}/product/showproductbycatgid/${catgId}`
            : `${process.env.REACT_APP_BACKEND_URL}/product/showproduct`;
