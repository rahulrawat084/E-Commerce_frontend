...
import"./EditCustomerProfile.css";
   ...
   function EditCustomerProfile({user,onClose,onUpdate})
   {
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_BACKEND_URL}/customer/getcustomerdetails/${user.Cid}`).then((res) => {
            setFormData(res.data);
            if(res.data.StId)
            {
                axios.get(`${process.env.REACT_APP_BACKEND_URL}/city/showcitybystate/${res.data.StId}`).then((ctRes) => setCtList(ctRes.data));
            }
        }).catch((err) => console.error(err));

        axios.get(`${process.env.REACT_APP_BACKEND_URL}/state/show/`).then((res) => setStList(res.data)).catch((err) => console.error(err));
    },[user.Cid])
    ...
    const handleStateChange = (e) => {
        ...
        axios.get(`${process.env.REACT_APP_BACKEND_URL}/city/showcitybystate/${stid}`).then((res) => setCtList(res.data)).catch((err) => console.error(err));
    };
    ...
    const handleSubmit =async () => {
        ...
        try{
            ...
            const res =await axios.put(`${process.env.REACT_APP_BACKEND_URL}/customer/update/${user.Cid}`,
                form,{
    ...
    <div className="edit-profile-container">
        ...
        <img className="edit-profile-img" src={preview ? preview : `${process.env.REACT_APP_BACKEND_URL}/customer/getimage/${formData.CPicName}`} alt="Customer" />
   ...
   export default EditCustomerProfile;
    ...
    //           <p>Profile Image</p>
    //           <img src={preview ? preview : `${process.env.REACT_APP_BACKEND_URL}/customer/getimage/${formData.CPicName}`}
